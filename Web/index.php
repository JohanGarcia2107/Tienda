        ...
        <div class="NuestrosServicios_container">
            <div class="Servicio">
                <div class="SevicioFrente">
                    <img loading="lazy" class="IMGServicio" src="IMGs/Inflabe.jpg" alt="Inflable">
                </div>
            ...
            <div class="Servicio">
                <div class="SevicioFrente">
                    <img loading="lazy" class="IMGServicio" src="IMGs/Parasol.jpg" alt="Parasoles">
                </div>
                <div class="ServicioAtras">
                    <h3>Parasoles</h3>
            ...
            <div class="Servicio">
                <div loading="lazy" class="SevicioFrente">
                    <img class="IMGServicio" src="IMGs/3d.jpg" alt="Impresion3d">
                </div>
                <div class="ServicioAtras">
                    <h3>Impresiones3d</h3>
    ...
    <section class="NuestrosTrabajos" id="NuestrosTrabajos">
        ...
        <div class="b">
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/1.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/2.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/3.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/4.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/5.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/6.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/7.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/8.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/9.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/11.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/12.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/13.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/14.jpg" alt="">
                </div>
            </div>
            <div class="NuestrosTrabajos_container">
                <div class="Trabajo">
                    <img loading="lazy" class="trabajos" src="IMGs/15.jpg" alt="">
                </div>
            </div>
        </div>
    </section>
